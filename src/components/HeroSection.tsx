...
const defaultSlides: Slide[] = [
  {
    ...
    description: "Effacement des frontières issues des conférences de Berlin. Rome, qui n’aura désormais que leurs yeux pour pleurer.",
  ...
  },
  {
    ...
    title: "Regroupement des dignes fils de Dieu dans une dynastie de vérité.",
    description: "Vingt et une nations sans frontières, un seul peuple, une seule civilisation, une seule loi. L’Afrique de l’Ouest reprend désormais sa dignité, ses droits et sa souveraineté.",
  ...
  },
  {
    ...
    title: "Convergence de toutes les brebis vers la nouvelle Sion (Banikoara)",
    description: "Un seul guide, une seule lumière : le Roi des rois, Zovizo.",
